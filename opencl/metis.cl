...
__constant const uint IV512metis[] __attribute__ ((aligned)) = {
...
__constant const uint mixtab0[] __attribute__ ((aligned)) = {
...
__constant const uint mixtab1[] __attribute__ ((aligned)) = {
...
__constant const uint mixtab2[] __attribute__ ((aligned)) = {
...
__constant const uint mixtab3[] __attribute__ ((aligned)) = {
...
#define SMIX(x0, x1, x2, x3)   { \
    uint c0 = mixtab0[(uchar)(x0 >> 24)] ^ mixtab1[(uchar)(x0 >> 16)] ^ mixtab2[(uchar)(x0 >>  8)] ^ mixtab3[(uchar)(x0)]; \
    uint c1 = mixtab0[(uchar)(x1 >> 24)] ^ mixtab1[(uchar)(x1 >> 16)] ^ mixtab2[(uchar)(x1 >>  8)] ^ mixtab3[(uchar)(x1)]; \
    uint c2 = mixtab0[(uchar)(x2 >> 24)] ^ mixtab1[(uchar)(x2 >> 16)] ^ mixtab2[(uchar)(x2 >>  8)] ^ mixtab3[(uchar)(x2)]; \
    uint c3 = mixtab0[(uchar)(x3 >> 24)] ^ mixtab1[(uchar)(x3 >> 16)] ^ mixtab2[(uchar)(x3 >>  8)] ^ mixtab3[(uchar)(x3)]; \
    uint r0 = mixtab0[(uchar)(x1 >> 24)] ^ mixtab0[(uchar)(x2 >> 24)] ^ mixtab0[(uchar)(x3 >> 24)];                        \
    uint r1 = mixtab1[(uchar)(x0 >> 16)] ^ mixtab1[(uchar)(x2 >> 16)] ^ mixtab1[(uchar)(x3 >> 16)];                        \
    uint r2 = mixtab2[(uchar)(x0 >>  8)] ^ mixtab2[(uchar)(x1 >>  8)] ^ mixtab2[(uchar)(x3 >>  8)];                        \
    uint r3 = mixtab3[(uchar)(x0      )] ^ mixtab3[(uchar)(x1      )] ^ mixtab3[(uchar)(x2      )];                        \
    x0 = ((c0 ^ r0) & (0xFF000000)) \
        | ((c1 ^ r1) & (0x00FF0000)) \
        | ((c2 ^ r2) & (0x0000FF00)) \
        | ((c3 ^ r3) & (0x000000FF)); \
...
#define ROR3 { uint T[3]; \
T[0] =  S33; T[1] =  S34; T[2] =  S35; \
 S35 =  S32;  S34 =  S31;  S33 =  S30;  S32 =  S29; \
 S31 =  S28;  S30 =  S27;  S29 =  S26;  S28 =  S25; \
 S27 =  S24;  S26 =  S23;  S25 =  S22;  S24 =  S21; \
 S23 =  S20;  S22 =  S19;  S21 =  S18;  S20 =  S17; \
 S19 =  S16;  S18 =  S15;  S17 =  S14;  S16 =  S13; \
 S15 =  S12;  S14 =  S11;  S13 =  S10;  S12 =   S9; \
 S11 =   S8;  S10 =   S7;   S9 =   S6;   S8 =   S5; \
  S7 =   S4;   S6 =   S3;   S5 =   S2;   S4 =   S1; \
  S3 =   S0; \
  S2 = T[2];   S1 = T[1];   S0 = T[0]; \
}

#define ROR8 { uint T[8]; \
T[0] =  S28; T[1] =  S29; T[2] =  S30; T[3] =  S31; \
T[4] =  S32; T[5] =  S33; T[6] =  S34; T[7] =  S35; \
 S35 =  S27;  S34 =  S26;  S33 =  S25;  S32 =  S24; \
 S31 =  S23;  S30 =  S22;  S29 =  S21;  S28 =  S20; \
 S27 =  S19;  S26 =  S18;  S25 =  S17;  S24 =  S16; \
 S23 =  S15;  S22 =  S14;  S21 =  S13;  S20 =  S12; \
 S19 =  S11;  S18 =  S10;  S17 =   S9;  S16 =   S8; \
 S15 =   S7;  S14 =   S6;  S13 =   S5;  S12 =   S4; \
 S11 =   S3;  S10 =   S2;   S9 =   S1;   S8 =   S0; \
  S7 = T[7];   S6 = T[6];   S5 = T[5];   S4 = T[4]; \
  S3 = T[3];   S2 = T[2];   S1 = T[1];   S0 = T[0]; \
}

#define ROR9 { uint T[9]; \
T[0] =  S27; T[1] =  S28; T[2] =  S29; T[3] =  S30; \
T[4] =  S31; T[5] =  S32; T[6] =  S33; T[7] =  S34; \
T[8] =  S35; \
 S35 =  S26;  S34 =  S25;  S33 =  S24;  S32 =  S23; \
 S31 =  S22;  S30 =  S21;  S29 =  S20;  S28 =  S19; \
 S27 =  S18;  S26 =  S17;  S25 =  S16;  S24 =  S15; \
 S23 =  S14;  S22 =  S13;  S21 =  S12;  S20 =  S11; \
 S19 =  S10;  S18 =   S9;  S17 =   S8;  S16 =   S7; \
 S15 =   S6;  S14 =   S5;  S13 =   S4;  S12 =   S3; \
 S11 =   S2;  S10 =   S1;   S9 =   S0; \
  S8 = T[8];   S7 = T[7];   S6 = T[6];   S5 = T[5]; \
  S4 = T[4];   S3 = T[3];   S2 = T[2];   S1 = T[1]; \
  S0 = T[0]; \
}
