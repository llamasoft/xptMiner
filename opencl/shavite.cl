...
__constant uint AES0[256] __attribute__ ((aligned)) = {
...
__constant uint AES1[256] __attribute__ ((aligned)) = {
...
__constant uint AES2[256] __attribute__ ((aligned)) = {
...
__constant uint AES3[256] __attribute__ ((aligned)) = {
